...
1. [`ADR_D1_REDIS_WORKER_RUNTIME_2026-08-20.md`](./ADR_D1_REDIS_WORKER_RUNTIME_2026-08-20.md)；
2. [`D1_REDIS_WORKER_CONTINUATION_PLAN_2026-08-20.md`](./D1_REDIS_WORKER_CONTINUATION_PLAN_2026-08-20.md)；
3. [`D1_REDIS_WORKER_GOAL_DRIVEN_PROMPT_2026-08-20.md`](./D1_REDIS_WORKER_GOAL_DRIVEN_PROMPT_2026-08-20.md)。

旧的PostgreSQL/D1双轨、信任分级和不可信学生Worker路线不再执行。
