...
|---|---:|---|
| whole attempt | 360 seconds | Unix wall-clock alarm plus cooperative checkpoints |
...
| result upload/finalize | 240 seconds | monotonic stage deadline and per-request timeout; the 360-second whole-attempt cap still applies |
