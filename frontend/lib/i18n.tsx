...
const messages = {
  zh: {
    ...
    "analysis.title": "Analysis Agent",
    "analysis.description": "描述你的研究目标并上传数据集，以生成 TaskSpec 并排队分析任务。",
    "analysis.researchGoal": "Research Goal",
    "analysis.dataset": "Dataset",
    "analysis.createTask": "Create Task",
    "analysis.agentOutput": "Agent Output",
    "analysis.noOutput": "No output yet. Send a research goal to start.",
    "analysis.noDraft": "请先运行 Analysis Agent 生成 TaskSpec 草稿。",
    "analysis.noDataset": "请选择一个数据集文件。",
  },
  en: {
    "language.switchToEnglish": "English",
    "language.switchToChinese": "中文",
    ...
    "analysis.title": "Analysis Agent",
    "analysis.description": "Describe your research goal and upload a dataset to generate a TaskSpec and queue an analysis task.",
    "analysis.researchGoal": "Research Goal",
    "analysis.dataset": "Dataset",
    "analysis.createTask": "Create Task",
    "analysis.agentOutput": "Agent Output",
    "analysis.noOutput": "No output yet. Send a research goal to start.",
    "analysis.noDraft": "No TaskSpec draft available. Please run the Analysis Agent first.",
    "analysis.noDataset": "Please select a dataset file.",
  },
} as const;
