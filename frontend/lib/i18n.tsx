...
const messages = {
  zh: {
    ...
    "tasks.enrollmentTokenHint": "请把这个持久凭证保存到目标机器的本地 Worker 配置中；数据库只保存摘要。",
  ...
  en: {
    ...
    "tasks.enrollmentTokenHint": "Save this persistent credential in the local Worker configuration; only its digest is stored in the database.",
