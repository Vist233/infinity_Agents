...
const messages = {
  zh: {
    ...
    "tasks.publicWorkersDescription": "超级用户管理公共执行池。公共 Worker 可以回退执行所有用户的排队任务，但用户看不到其他人的任务。",
    ...
    "tasks.publicWorkersCreate": "创建一个公共 Worker",
    "tasks.publicWorkersProvisioning": "创建中…",
    "tasks.publicWorkersReady": "公共池已有两个 Worker。",
    "tasks.publicWorkersNamespace": "Namespace",
    "tasks.publicWorkersSlot": "公共 Worker {{slot}}",
  ...
  en: {
    ...
    "tasks.publicWorkersDescription": "Superusers manage the shared execution pool. Public Workers can fall back to queued tasks from all users, while users cannot see one another's tasks.",
    ...
    "tasks.publicWorkersCreate": "Create one public Worker",
    "tasks.publicWorkersProvisioning": "Creating…",
    "tasks.publicWorkersReady": "The public pool already has two Workers.",
    "tasks.publicWorkersNamespace": "Namespace",
    "tasks.publicWorkersSlot": "Public Worker {{slot}}",
    "tasks.publicWorkersWorkerId": "Worker ID",
